 ...
 */
public class HookModelAppSettingsAdvancedSimSerialNumber
{
    public final String SaveFlag      = HookModelAppListWorker.GetAppSettingsString(5);
    public final String XmlFlag       = HookModelAppListWorker.GetAppSettingsString(10);
